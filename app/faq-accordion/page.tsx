...
const Page = (): JSX.Element => (
  <main
    className={`${style["colors"]} ${style["background"]} ${workSans.className} grid min-h-screen place-items-center bg-contain bg-fixed bg-top bg-no-repeat p-6 text-(--dark-purple)`}
  >
