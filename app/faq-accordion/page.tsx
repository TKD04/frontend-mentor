...
const Page = (): JSX.Element => (
  <main
    className={`${style["colors"]} ${workSans.className} grid min-h-screen place-items-center bg-[url(/faq-accordion/background-pattern-mobile.svg)] bg-contain bg-fixed bg-top bg-no-repeat p-6 text-(--dark-purple) lg:bg-[url(/faq-accordion/background-pattern-desktop.svg)]`}
  >
